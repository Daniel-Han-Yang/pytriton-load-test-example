...
sbertmodel = SentenceTransformer('multi-qa-MiniLM-L6-cos-v1').to("cuda").eval()
...
with Triton() as triton:
    ...
    triton.bind(
        ...
        infer_func=[_InferFuncWrapper(sbertmodel, "cuda"), _InferFuncWrapper(sbertmodel, "cuda"), _InferFuncWrapper(sbertmodel, "cuda")],
        inputs=[
